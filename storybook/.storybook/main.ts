...
const config: StorybookConfig = {
  ...
  async viteFinal(cfg) {
    ...
    cfg.resolve = {
      ...
      // `@wm-storefront/ui/utils` must be tried before the bare `@wm-storefront/ui`.
      alias: [
        { find: /^@wm-storefront\/ui\/(.*)$/, replacement: pkg("ui", "/$1") },
        { find: /^@wm-storefront\/ui$/, replacement: pkg("ui", "/index.ts") },
        { find: /^@wm-storefront\/commerce-ui\/(.*)$/, replacement: pkg("commerce-ui", "/$1") },
        { find: /^@wm-storefront\/commerce-ui$/, replacement: pkg("commerce-ui", "/index.ts") },
        { find: /^@wm-storefront\/commerce-core\/(.*)$/, replacement: pkg("commerce-core", "/$1") },
        { find: /^@wm-storefront\/commerce-core$/, replacement: pkg("commerce-core", "/index.ts") },
      ],
