...
const NavigationMenu = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof NavigationMenuPrimitive.Root> & {
    /**
     * Radix's viewport is the shared, auto-sized popup box every panel animates
     * into — right for dropdown-sized menus, wrong for a full-bleed megamenu
     * panel that spans the header. Pass `viewport={false}` and each
     * `NavigationMenuContent` positions itself instead.
     */
    viewport?: boolean;
  }
